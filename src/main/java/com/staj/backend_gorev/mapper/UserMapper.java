...
public interface UserMapper {
    ...
    // @mapping dto ile entity degerlerini karsılastirir.Aynı ise mapping yazmasanda
    // olur ama biz hep target = id ... kullanmaliyiz.
    ...
    // MappingTargetle yeni nesne yaratmaz direkt depodaki nesneyi günceller.Var
    // olan nesnede islem yapar .
}